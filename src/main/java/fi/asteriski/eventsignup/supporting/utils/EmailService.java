...
import fi.asteriski.eventsignup.supporting.event.SavedEventSpringEvent;
import fi.asteriski.eventsignup.supporting.event.SignupCancelledSpringEvent;
import fi.asteriski.eventsignup.supporting.event.SignupSuccessfulSpringEvent;
